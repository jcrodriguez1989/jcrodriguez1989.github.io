...
I have a master's degree in Computer Science, and I am finishing my master's degree in Applied Statistics and a PhD in computer science (hopefuly I will defend both theses this year `r ji("sweat_smile")`). However, I would like to define myself as a computer science enthusiast. I really enjoy coding. My soul mate programming language is R `r ji("ring")`, however, I sometimes cheat on it with Python, C and C ++ `r ji("stuck_out_tongue_closed_eyes")`.
